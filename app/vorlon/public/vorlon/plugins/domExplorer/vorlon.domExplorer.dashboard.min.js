...
(function (VORLON) {
    var DOMExplorerDashboard = (function (_super) {
        ...
        DOMExplorerDashboard.prototype.startDashboardSide = function (div) {
            ...
            this._insertHtmlContentAsync(this._dashboardDiv, function (filledDiv) {
                ...
                _this._searchresults = VORLON.Tools.QuerySelectorById(filledDiv, "searchresults");
                ...
                _this.inspectButton = _this._containerDiv.querySelector('x-action[event="inspect"]');
                _this._stylesEditor = new DomExplorerPropertyEditor(_this);
                _this._containerDiv.addEventListener('inspectFromClient', function () {
                    _this.sendCommandToClient('inspect');
                });
        ...
        DOMExplorerDashboard.prototype.searchDOM = function () {
            ...
            this._searchinput.addEventListener("keydown", function (evt) {
                if (evt.keyCode === 13 || evt.keyCode === 9) {
                    evt.preventDefault();
                    _this._searchresults.innerHTML = "";
                    _this._searchresults.classList.remove('noresults');
                    _this._searchresults.classList.remove('found');
        ...
        DOMExplorerDashboard.prototype.hoverNode = function (internalId, unselect) {
            ...
            if (!internalId) {
                ...
                setTimeout(function () {
                    if (!_this._highlightedNode) {
                        _this.sendCommandToClient('unhighlight', {
                            order: internalId
                        });
                    }
                }, 5);
        ...
        DOMExplorerDashboard.prototype.setNodeStyle = function (internalId, styles) {
    ...
    var DomExplorerNode = (function () {
        ...
        DomExplorerNode.prototype.renderDOMNodeContent = function () {
            var _this = this;
            var root = VORLON.FluentDOM.forElement(this.element);
            ...
            var menu = function (idtarget) {
                ...
                var option = {
                    width: 180, items: [
                        {
                            text: "Edit content as HTML", icon: "", alias: "1-1", action: function () {
                        ...
                        {
                            text: "Add attribute", alias: "1-3", icon: "", action: function () {
        ...
        DomExplorerNodeAttribute.prototype.eventNode = function (nodeName, nodeValue, parentElementId) {
            ...
            var menu = function () {
                var option = {
                    width: 180, items: [
                        {
                            text: "Edit attribute name", icon: "", alias: "1-1", action: function () {
                                that.parent.plugin.makeEditable(nodeName);
                            }
                        },
                        {
                            text: "Edit attribute value", alias: "1-2", icon: "", action: function () {
                                that.parent.plugin.makeEditable(nodeValue);
                            }
                        },
                        {
                            text: "Edit content as HTML", alias: "1-3", icon: "", action: function () {
                        ...
                        {
                            text: "Add attribute", alias: "1-4", icon: "", action: function () {
                                that.parent.addAttribute("name", "value");
                            }
                        },
                        {
                            text: "Delete attribute", alias: "1-5", icon: "", action: function () {
    ...
    var DomExplorerPropertyEditor = (function () {
        ...
        DomExplorerPropertyEditor.prototype.generateStyles = function (node, internalId, styles) {
            var _this = this;
            this.node = node;
